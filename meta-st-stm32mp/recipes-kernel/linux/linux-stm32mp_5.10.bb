...
SRC_URI = "https://cdn.kernel.org/pub/linux/kernel/v5.x/${LINUX_TARNAME}.tar.xz;name=kernel \
           ...
           file://${LINUX_VERSION}/fragment-03-systemd.config;subdir=fragments \
           ...
           file://0003-bringup-fusb302-and-support-UFP-DFP-recognize.patch \
           file://0001-suppot-ov5640-camera.patch \
           file://0002-fix-usb-host-port-cannot-recognize-device-issue.patch \
           "
