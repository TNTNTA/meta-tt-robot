...
SRC_URI = "${@bb.utils.contains('MACHINE_FEATURES', 'splashscreen', 'file://${UBOOT_SPLASH_LANDSCAPE_SRC} file://${UBOOT_SPLASH_PORTRAIT_SRC} file://${UBOOT_SPLASH_TTROBOT_SRC}', '', d)}"
...
UBOOT_SPLASH_TTROBOT_SRC = "TTRobot_splash_800x480.bmp"
...
do_install() {
    ...
    # fi
    if [ -e "${S}/${UBOOT_SPLASH_TTROBOT_SRC}" ]; then
        install -m 644 ${S}/${UBOOT_SPLASH_TTROBOT_SRC} ${D}/boot/${UBOOT_SPLASH_TTROBOT_IMAGE}.bmp
    fi
}
